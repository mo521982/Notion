const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到xinhui云居民博客', url: 'https://55795496.xyz' },
    { title: '访问本站获取更多帮助', url: 'https://55795496.xyz' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '分享经验',
  HEO_HERO_TITLE_2: '与世界同在',
  HEO_HERO_TITLE_3: '55795496.xyz',
  HEO_HERO_TITLE_4: 'xinhui世界',
  HEO_HERO_TITLE_5: '将虚拟资本=现实金钱的方法',
  ...
  HEO_INFO_CARD_URL3: 'https://55795496.xyz',
