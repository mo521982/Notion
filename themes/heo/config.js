const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-12-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.2xinhui.com' },
    { title: '关于博主Xinhui', url: 'https://www.2xinhui.com/about' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必选精看' },
  HEO_HERO_CATEGORY_2: { title: '热门文章', url: '/tag/海外开户' },
  HEO_HERO_CATEGORY_3: { title: '实用教程', url: '/tag/实用工具' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HEO_HERO_RECOMMEND_POST_TAG: '推荐',
  HEO_HERO_RECOMMEND_POST_SORT_BY_UPDATE_TIME: false, // 推荐文章排序，为`true`时将强制按最后修改时间倒序
  //   HERO_RECOMMEND_COVER: 'https://pan.910520.xyz/raw/public/tool/PIC/cb27e613b4b39da5845203c2d7d79c9f.jpeg', // 英雄区右侧图片
