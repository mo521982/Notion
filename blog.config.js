...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xinhui工作室', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '网络数字云居民🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.2xinhui.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'U卡, 海外开户', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个Xinhui, Hi，我是一个云居民,Hi，我是一个干饭人,欢迎来到我的博客🎉',
