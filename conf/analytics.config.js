...
module.exports = {
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || 'Kwzexm75XkxEXqNf', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || 'Kwzexm75XkxEXqNf', // ck，在51la后台获取
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 't7sxxeaj2s', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
