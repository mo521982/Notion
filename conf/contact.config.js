...
module.exports = {
  ...
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '@xinhui999', // 你的twitter个人主页
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '@xinhui999', // 你的telegram 地址 例如 https://t.me/tangly_1024
